<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdatePage.aspx.cs" Inherits="EmployeTrackingSystem.UpdatePage" %>
    ...
    <html lang="en">
      ...
      <body>
        <div class="container border" style="display: block">
          ...
          <div class="form-group row">
            <a href="#" class="btn btn-success col-sm-2"> Update</a>
          </div>
        </div>
      </body>
    </html>
